...
;; `json-parse-string'.  Just like with `json-parse-string' you can also get the TOML
;; data as a `alist' or `plist' object.  See the documentation of the functions for
;; details.
;;
...
;; https://github.com/tree-sitter-grammars/tree-sitter-toml You can install toml grammar
;; by the following snippet in your startup file
;;
